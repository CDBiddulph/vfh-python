...
class Bike:
    ...
    def update_yaw(self, follow_x, follow_y):
        ...
        curvature = get_curvature(follow_x, follow_y, self.x, self.y, reverse_x, reverse_y)
        sign = -math.sin(self.heading - math.atan2(follow_y - self.y, follow_x - self.x))
    ...
    def get_reverse_point(self, follow_x, follow_y):
        ...
        reverse_x = self.x + magnitude * math.cos(reverse_heading)
        reverse_y = self.y + magnitude * math.sin(reverse_heading)
